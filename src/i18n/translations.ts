...
const zhCN: LandingDict = {
  ...
  downloadNote: 'Windows / Linux / Android 版本已发布',
  downloadPlatformNote: 'macOS / iPad / iOS 正在开发中',
...
const zhTW: LandingDict = {
  ...
  downloadNote: 'Windows / Linux / Android 版本已發佈',
  downloadPlatformNote: 'macOS / iPad / iOS 正在開發中',
...
const en: LandingDict = {
  ...
  downloadNote: 'Windows / Linux / Android versions available',
  downloadPlatformNote: 'macOS / iPad / iOS coming soon',
